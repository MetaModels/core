...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['skipfilteroptions'] = array('Ignore this filter for the remaining values', 'If activate the filter will return all options without itself in the filter rules.');
...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['pasteinto'][1]  = 'Create new at the top of setting ID %s';
