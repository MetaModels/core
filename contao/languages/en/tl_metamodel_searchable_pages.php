...
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['rendersetting']               = array('Rendersetting', 'Choose the rendersetting which will be used for the search rendering.');
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['jumpTo']               = array('JumpTo page', 'The page that shall be used as for the search index. Note that the detailed URL params will get generated by the filter setting that is currently in use.');
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['jumpTo_allLanguages']  = 'All languages';
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['jumpTo_language']      = array('Language', 'The language for the jump to page.');
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['jumpTo_page']          = array('Jump to page', 'The page to use for detail links.');
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['jumpTo_filter']        = array('Filter settings', 'The filter settings that define how the target (the reader/lister on the detail page) will identify it\'s matches.');
$GLOBALS['TL_LANG']['tl_metamodel_searchable_pages']['showEmptyValues']      = array('Show empty values', 'Show empty values in search results.');
