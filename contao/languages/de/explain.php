 ...
 *
 * last-updated: 2015-09-18T16:13:03+02:00
 */
...
$GLOBALS['TL_LANG']['XPL']['customsql']['1']['1'] = '<pre>SELECT id
FROM mm_mymetamodel
WHERE page_id=1</pre> Dieses selektiert alle IDs von der Tabelle <em>mm_mymetamodel</em> bei welchen Wert <em>page_id=1</em> ist.
';
