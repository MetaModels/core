...
$GLOBALS['TL_LANG']['BRD']['metamodel_rendersetting']                                 = 'Настройки отображения в "%s"';
$GLOBALS['TL_LANG']['BRD']['metamodel_rendersettings']                                = 'Все настройки отображения "%s"';
...
$GLOBALS['TL_LANG']['ERR']['invalidColumnName']                                       = 'Недопустимое имя колонки "%s".';
$GLOBALS['TL_LANG']['ERR']['invalidTableName']                                        = 'Недопустимое имя таблицы "%s".';
...
$GLOBALS['TL_LANG']['ERR']['systemColumn']                                            = 'Имя колонки "%s" зарезервировано для системного использования.';
...
$GLOBALS['TL_LANG']['MSC']['metamodel_rendersetting']['editRecord']                   = 'Редактировать атрибут параметра %%s for render setting "%s" в MetaModel "%s"';
