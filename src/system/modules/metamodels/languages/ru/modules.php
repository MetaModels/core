...
$GLOBALS['TL_LANG']['FMD']['metamodel_list']['1']              = 'Добавляет список элементов MetaModel на страницу.';
...
$GLOBALS['TL_LANG']['FMD']['metamodels_frontendclearall']['0'] = 'MetaModel очистить все';
$GLOBALS['TL_LANG']['FMD']['metamodels_frontendclearall']['1'] = 'Добавляет очистить все для всех фильтров внешнего интерфейса.';
$GLOBALS['TL_LANG']['FMD']['metamodels_frontendfilter']['0']   = 'MetaModel фильтр внешнего интерфейса';
$GLOBALS['TL_LANG']['FMD']['metamodels_frontendfilter']['1']   = 'Добавляет фильтр внешнего интерфейса для MetaModel.';
