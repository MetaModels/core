...
$GLOBALS['TL_LANG']['tl_metamodel_dca']['backendsectionpos']['0']    = 'Backend-Bereich Position';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['backendsectionpos']['1']    = 'Geben Sie die Position in dem Backend-Bereich an, an der das MetaModel erscheinen soll. Diese Positionierung gilt nur für MetaModels untereinander (z.B. in einem komplett eigenen Bereich).';
