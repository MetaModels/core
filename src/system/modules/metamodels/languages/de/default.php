...
$GLOBALS['TL_LANG']['MSC']['metamodel_edit_as_child']['label'] 			= '"%s" für Element %%s bearbeiten';
$GLOBALS['TL_LANG']['MSC']['sorting'] 									= 'Sortierung';

// Stylepicker
$GLOBALS['TL_LANG']['MSC']['tl_class']['w50']         					= array('w50', 'Die Breite auf 50% festlegen und nach links floaten.');
