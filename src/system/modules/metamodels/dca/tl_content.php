...
(
	...
	'metamodel_availableValues' => array
	(
		'label'                   => &$GLOBALS['TL_LANG']['tl_content']['metamodel_availableValues'],
		'exclude'                 => true,
		'inputType'               => 'checkbox',
		'eval' => array
		(
