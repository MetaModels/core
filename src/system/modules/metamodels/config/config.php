...
(
	...
	(
		...
		(
			...
			'dca_addall'            => array('MetaModels\Dca\DcaSetting', 'addAll'),
...
if (TL_MODE == 'BE')
{
	...
	if (version_compare(VERSION,'3.1', '>=') && \Environment::get('scriptName') == (TL_PATH . '/contao/file.php') && stripos(\Input::get('do'), 'metamodel') !== false)
	{
