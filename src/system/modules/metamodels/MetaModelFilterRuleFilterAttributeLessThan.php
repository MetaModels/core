...
/**
 * This is the MetaModelFilterRule class for handling "less-than" comparision on attributes.
 *
 * @package	   MetaModels
 * @subpackage Core
 * @author     Christian Schiffler <c.schiffler@cyberspectrum.de>
 */
class MetaModelFilterRuleFilterAttributeLessThan implements IMetaModelFilterRule
{
	/**
