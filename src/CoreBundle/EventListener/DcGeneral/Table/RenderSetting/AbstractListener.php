...
abstract class AbstractListener extends AbstractAbstainingListener
{
    ...
    {
        if (!(($model->getProviderName() === 'tl_metamodel_rendersetting') && $model->getProperty('pid'))) {
            throw new DcGeneralInvalidArgumentException(
                \sprintf(
                    'Model must originate from tl_metamodel_rendersetting and be saved, this one originates from ' .
                    '%s and has pid %s',
