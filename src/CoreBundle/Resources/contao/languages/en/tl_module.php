...
$GLOBALS['TL_LANG']['tl_module']['metamodel_parameter_wizard'][0]             = 'Parameters';
$GLOBALS['TL_LANG']['tl_module']['metamodel_parameter_wizard'][1]             =
    'Set your own parameters as "key-value-pairs".';
$GLOBALS['TL_LANG']['tl_module']['metamodel_parameter_wizard_description'][0] = 'Description';
$GLOBALS['TL_LANG']['tl_module']['metamodel_meta_title'][1]                   =
    'Set description.';
$GLOBALS['TL_LANG']['tl_module']['metamodel_parameter_wizard_key'][0]         = 'Key';
$GLOBALS['TL_LANG']['tl_module']['metamodel_meta_title'][1]                   =
    'Set key.';
$GLOBALS['TL_LANG']['tl_module']['metamodel_parameter_wizard_value'][0]       = 'Value';
$GLOBALS['TL_LANG']['tl_module']['metamodel_meta_title'][1]                   =
    'Set value.';
