...
$GLOBALS['TL_LANG']['tl_metamodel_filter']['edit'][1]       = 'Edit the filter setting ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['copy'][0]       = 'Copy filter setting';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['copy'][1]       = 'Copy the filter setting ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['delete'][0]     = 'Delete filter setting';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['delete'][1]     = 'Delete the filter setting ID %s';
...
$GLOBALS['TL_LANG']['tl_metamodel_filter']['deleteConfirm'] = 'Do you really want to delete filter setting ID %s?';
