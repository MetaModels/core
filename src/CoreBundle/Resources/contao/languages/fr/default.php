...
$GLOBALS['TL_LANG']['CTE']['metamodels_frontendclearall']['0']                        = 'MetaModel "Effacer tout"';
$GLOBALS['TL_LANG']['CTE']['metamodels_frontendclearall']['1']                        = 'Ajoute un "Effacer tout" pour tous les filtres du font office.';
...
$GLOBALS['TL_LANG']['ERR']['columnDoesNotExist']                                      = 'La colonne "%s" n\'existe pas sur le tableau"%s".';
$GLOBALS['TL_LANG']['ERR']['columnExists']                                            = 'La colonne "%s" existe déjà sur le tableau "%s".';
$GLOBALS['TL_LANG']['ERR']['install_extension']                                       = 'Veuillez s\'il vous plaît installer l\'extension requise "%s" (%s)';
$GLOBALS['TL_LANG']['ERR']['invalidColumnName']                                       = 'Le nom de colonne "%s" est invalide.';
$GLOBALS['TL_LANG']['ERR']['invalidTableName']                                        = 'Le nom de tableau "%s" est invalide.';
$GLOBALS['TL_LANG']['ERR']['no_attribute_extension']                                  = 'Veuillez installer au moins une extension d\'attribut ! Les Metamodels sans attributs n\'ont aucun sens.';
$GLOBALS['TL_LANG']['ERR']['no_palette']                                              = 'Tenter d\'accéder au MetaModel "%s" sans écran de saisie pour l\'utilisateur courant %s.';
$GLOBALS['TL_LANG']['ERR']['no_view']                                                 = 'Tenter d\'accéder au MetaModel "%s" sans vue pour l\'utilisateur %s.';
$GLOBALS['TL_LANG']['ERR']['systemColumn']                                            = 'Le nom de colonne "%s" est réservé au fonctionnement du système.';
...
$GLOBALS['TL_LANG']['MSC']['metamodel_filtersetting']['editRecord']                   = 'Éditer les paramètres %%s du filtre "%s" du MetaModel "%s"';
$GLOBALS['TL_LANG']['MSC']['metamodel_filtersetting']['label']                        = 'Filtre "%s" du MetaModel "%s"';
...
$GLOBALS['TL_LANG']['MSC']['tl_class']['clx']['1']                                    = 'Enlever seulement le débordement caché ennuyeux, à utiliser avec "clr".';
$GLOBALS['TL_LANG']['MSC']['tl_class']['long']['0']                                   = 'long';
$GLOBALS['TL_LANG']['MSC']['tl_class']['long']['1']                                   = 'Etendre le champ de saisie sur deux colonnes.';
$GLOBALS['TL_LANG']['MSC']['tl_class']['m12']['0']                                    = 'm12';
$GLOBALS['TL_LANG']['MSC']['tl_class']['m12']['1']                                    = 'Ajoute 12 pixels à la marge haute de l\'élément (utilisé pour les cases à cocher simples).';
$GLOBALS['TL_LANG']['MSC']['tl_class']['w50']['0']                                    = 'w50';
$GLOBALS['TL_LANG']['MSC']['tl_class']['w50']['1']                                    = 'Définir la largeur du champ à 50% et son type de flottant (float:left).';
$GLOBALS['TL_LANG']['MSC']['tl_class']['w50x']['0']                                   = 'w50x';
$GLOBALS['TL_LANG']['MSC']['tl_class']['w50x']['1']                                   = 'Retirer seulement la hauteur fixe ennuyeuse, à utiliser avec "w50".';
$GLOBALS['TL_LANG']['MSC']['tl_class']['wizard']['0']                                 = 'wizard';
$GLOBALS['TL_LANG']['MSC']['tl_class']['wizard']['1']                                 = 'Raccourcir le champ de saisie de sorte qu\'il y ait assez de place pour le bouton Assistant (ex :  champ sélecteur de date).';
$GLOBALS['TL_LANG']['metamodels_frontendfilter']['action_add']                        = '+';
$GLOBALS['TL_LANG']['metamodels_frontendfilter']['action_remove']                     = '-';
$GLOBALS['TL_LANG']['metamodels_frontendfilter']['clear_all']                         = 'Effacer tous les filtres';
$GLOBALS['TL_LANG']['metamodels_frontendfilter']['do_not_filter']                     = 'Pas de filtrage';
