...
$GLOBALS['TL_LANG']['tl_module']['editfiltersetting']['1']                = 'Editer les paramètres de filtre ID %s.';
...
$GLOBALS['TL_LANG']['tl_module']['editrendersetting']['0']                = 'Editer les paramètres de rendu';
