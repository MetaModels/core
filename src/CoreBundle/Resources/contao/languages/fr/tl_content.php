...
$GLOBALS['TL_LANG']['tl_content']['metamodel_limit']['1']                     = 'Veuillez entrer le nombre maximum d\'éléments - entrez 0 pour afficher tous les éléments.';
...
$GLOBALS['TL_LANG']['tl_content']['metamodel_order_by_param']['0']            = 'Remplacer la clé par Order by';
$GLOBALS['TL_LANG']['tl_content']['metamodel_order_by_param']['1']            = 'Vous pouvez remplacer la clé par défaut « orderBy ».';
$GLOBALS['TL_LANG']['tl_content']['metamodel_page_param_type']['1']           = 'Veuillez spécifier le type de paramètres d\'URL comme alias(clé/valeur) ou GET (clé=valeur).';
$GLOBALS['TL_LANG']['tl_content']['metamodel_param_type_options']['get']      = 'Seulement GET';
$GLOBALS['TL_LANG']['tl_content']['metamodel_param_type_options']['slug']     = 'Seulement Slug';
$GLOBALS['TL_LANG']['tl_content']['metamodel_param_type_options']['slugNget'] = 'Slug ou GET autorisé';
...
$GLOBALS['TL_LANG']['tl_content']['metamodel_sort_override']['0']             = 'Autoriser le remplacement du tri';
$GLOBALS['TL_LANG']['tl_content']['metamodel_sort_override']['1']             = 'Si cette case est cochée, l\'attribut de tri et l\'ordre peuvent être remplacés via le paramètre get.';
$GLOBALS['TL_LANG']['tl_content']['metamodel_sort_param_type']['0']           = 'Type d\'URL pour les paramètres';
...
$GLOBALS['TL_LANG']['tl_content']['mm_pagination_legend']                     = 'Pagination du MetaModel';
